...
import blendTea from "../../../images/boldTeaShadow.png";
import IconHeading from "../../CommonComponent/IconHeading/IconHeading";

const BoldTea = () => {
    return (
        <div className="bold-tea">
            <div className="container bold-tea-bg">
                <IconHeading
                ...
                <div
                    ...
                    style={{ backgroundColor: "#365849", padding: "65px 0" }}
                >
